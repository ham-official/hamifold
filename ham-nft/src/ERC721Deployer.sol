...
import {HamERC721} from "./HamERC721.sol";
import {Clones} from "@openzeppelin/contracts/proxy/Clones.sol";

contract ERC721Deployer is Owned, Initializable {
    ...
    function initialize() public initializer {
        owner = msg.sender;
        erc721Implementation = address(new HamERC721());
    ...
    function ham721Deploy(string memory name, string memory token) public {
        ...
        HamERC721(cloneAddress).init(name, token, msg.sender);
